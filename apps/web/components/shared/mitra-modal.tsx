              ...
              <form onSubmit={handleSubmit} className="p-8 space-y-8">
                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <h3 className="text-sm font-black text-slate-800 uppercase tracking-wide">Informasi Pemilik (Mitra)</h3>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-5">
                    ...
                    <div className="space-y-2 col-span-2 sm:col-span-1">
                      <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Email Mitra</label>
                      <div className="relative group/input">
                        <span className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within/input:text-indigo-600 transition-colors">
                          <HiOutlineEnvelope />
                        </span>
                ...
                <div className="space-y-4 pt-4 border-t border-slate-100">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <h3 className="text-sm font-black text-slate-800 uppercase tracking-wide">Informasi Cabang (Outlet)</h3>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-5">
                    ...
                    <div className="space-y-2 col-span-2 sm:col-span-1">
                      <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Slug URL (Tanpa Spasi)</label>
                      <div className="relative group/input">
                        <span className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within/input:text-indigo-600 transition-colors">
                          <HiOutlineLink />
                        </span>
                        <input 
                          required name="outletSlug"
                    ...
                    <div className="space-y-2 col-span-2">
                      <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Franchise Fee / Royalti (%)</label>
                      <div className="relative group/input">
                        <span className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within/input:text-indigo-600 transition-colors">
                          <HiOutlineCurrencyDollar />
                        </span>
                        <input 
                          required type="number" name="franchiseFee" defaultValue="5" min="0" max="100"
                          className="w-full pl-12 pr-6 py-4 bg-slate-50 border border-slate-100 rounded-2xl text-sm font-bold outline-none ring-0 focus:border-indigo-500 focus:bg-white transition-all"
                        />
                      </div>
                      <p className="text-[10px] text-slate-400 italic ml-1">Persentase bagi hasil bulanan yang akan dipotong dari pendapatan outlet.</p>
                    </div>
                  </div>
                </div>
