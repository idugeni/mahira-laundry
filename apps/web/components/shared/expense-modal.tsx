            ...
            <div className="px-8 pt-8 pb-6 bg-slate-50 relative overflow-hidden shrink-0 border-b border-slate-100">
              ...
              <div className="relative flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h2 className="text-xl font-black text-slate-900 tracking-tight">Catat <span className="text-rose-600">Pengeluaran</span></h2>
                    <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-0.5">Operasional & Biaya Lainnya</p>
                  </div>
                </div>
                <button 
              ...
              <div className="space-y-4">
                <div className="space-y-2">
                  ...
                  <div className="relative group/input">
                    <span className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within/input:text-rose-600 transition-colors">
                      <HiOutlineTag />
                    </span>
                    <select 
                      name="category" required
                      className="w-full pl-12 pr-6 py-4 bg-slate-50 border border-slate-100 rounded-2xl text-sm font-bold outline-none ring-0 focus:border-rose-500 focus:bg-white transition-all appearance-none"
                    >
                      {CATEGORIES.map(cat => (
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative group/input">
                    <span className="absolute left-4 top-1/2 -translate-y-1/2 text-lg font-bold text-slate-400 group-focus-within/input:text-rose-600 transition-colors">Rp</span>
                    <input 
                      required type="number" name="amount"
                      placeholder="0"
