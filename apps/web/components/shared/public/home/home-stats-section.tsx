					...
					<div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-16">
						{stats.map((stat, i) => (
							<motion.div
								...
								className="relative group flex flex-col items-center text-center min-w-0"
							>
								<div className="mb-6 relative">
									<div className="w-12 h-12 sm:w-16 sm:h-16 rounded-full bg-white/5 flex items-center justify-center text-2xl sm:text-3xl text-brand-accent transition-all duration-500 group-hover:bg-brand-accent group-hover:text-slate-900 group-hover:rotate-[15deg] shadow-xl group-hover:shadow-brand-accent/30 ring-1 ring-white/5 group-hover:ring-brand-accent">
										{icons[i]}
									</div>
									<div className="absolute -inset-3 sm:-inset-4 bg-brand-accent/5 blur-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-1000" />
								</div>

								<div className="text-2xl sm:text-4xl md:text-5xl font-black text-white font-[family-name:var(--font-heading)] mb-2 tracking-tight">
								...
								<div className="text-[8px] sm:text-[10px] md:text-xs font-black text-brand-accent uppercase tracking-[0.15em] sm:tracking-[0.3em] leading-relaxed break-all sm:break-normal">
									{stat.label}
								</div>
							</motion.div>
						))}
