								...
								return (
									...
									>
										...
										<div className="relative">
											<h3 className="text-2xl font-black font-[family-name:var(--font-heading)] text-slate-900 mb-4 tracking-tight transition-colors duration-300 group-hover:text-brand-primary">
												{service.name}
											</h3>
