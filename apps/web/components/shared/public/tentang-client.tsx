					...
					>
						...
						<div className="grid gap-6">
							{[
								...
								"Memberikan standar kebersihan tertinggi dengan Quality Control 3 lapis",
						...
						<div className="grid sm:grid-cols-2 gap-8">
							{[
								...
								},
								{
									...
									desc: "Keharuman eksklusif yang dirancang khusus untuk kesegaran pakaian tahan lama.",
									color: "text-pink-500",
									bg: "bg-pink-50",
								},
								{
