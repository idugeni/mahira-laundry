...
import { generateReportData, ReportType } from "@/lib/actions/reports";
          ...
          <div className="relative bg-white rounded-[2.5rem] shadow-2xl w-full max-w-lg overflow-hidden animate-zoom-in border border-white/20">
             ...
             <div className="px-8 pt-8 pb-6 bg-slate-50 relative overflow-hidden shrink-0 border-b border-slate-100">
              ...
              <div className="relative flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h2 className="text-xl font-black text-slate-900 tracking-tight">Kustomisasi <span className="text-pink-600">Laporan</span></h2>
                    <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-0.5">Filter & Ekspor Data Operasional</p>
                  </div>
                </div>
                <button 
            ...
            <div className="p-8 space-y-6">
              ...
              <div className="space-y-3">
                <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Jenis Laporan</label>
                <div className="grid grid-cols-2 gap-3">
                  {[
                    { id: "harian", label: "Harian", icon: <HiOutlineCalendar /> },
                    { id: "bulanan", label: "Bulanan", icon: <HiOutlineDocumentChartBar /> },
                    { id: "keuangan", label: "Keuangan", icon: <HiOutlineCurrencyDollar /> },
                    { id: "mingguan", label: "Volume Order", icon: <HiOutlineShoppingCart /> }
                  ].map((type) => (
                    <button
                      key={type.id}
              ...
              <div className="space-y-3 pt-2">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-2">
                    <p className="text-[9px] font-bold text-slate-400 uppercase tracking-tight ml-1 text-center">Mulai Dari</p>
                    <input 
                      type="date" 
                  ...
                  <div className="space-y-2">
                    <p className="text-[9px] font-bold text-slate-400 uppercase tracking-tight ml-1 text-center">Sampai Dengan</p>
                    <input 
                      type="date" 
                      value={dateRange.to}
              ...
              <div className="pt-4">
                ...
                <p className="text-[10px] text-center text-slate-400 mt-4 px-8 italic">
                  Data yang diekspor disinkronkan langsung dengan basis data utama Mahira Laundry untuk akurasi pelaporan.
                </p>
              </div>
            </div>
          </div>
