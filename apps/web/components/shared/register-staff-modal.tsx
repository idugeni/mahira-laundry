								...
								<div className="relative flex items-center justify-between">
									<div>
										<h2 className="text-2xl font-black text-slate-900 tracking-tight font-[family-name:var(--font-heading)]">
											Registrasi{" "}
											<span className="text-brand-primary">Staf</span>
										</h2>
								...
								<form onSubmit={handleSubmit} className="p-8 space-y-5">
										...
										<div className="space-y-2">
											...
											<Select value={role} onValueChange={setRole}>
												...
												<SelectContent className="rounded-2xl border-slate-100 shadow-2xl">
													<SelectItem value="kasir" className="font-bold py-3">
														Kasir Operasional
													</SelectItem>
													<SelectItem value="kurir" className="font-bold py-3">
														Kurir Penjemputan
													</SelectItem>
													<SelectItem
														value="manager"
									...
									<div className="space-y-2">
										<div className="flex items-center justify-between mx-1">
											...
											<span className="text-[9px] font-black text-brand-primary bg-brand-primary/10 px-2 py-0.5 rounded-full uppercase tracking-tighter">
												Default: Mahira123!
											</span>
										</div>
										<div className="relative group/input">
