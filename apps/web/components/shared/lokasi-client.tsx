              ...
              <div className="relative z-10">
                <div className="flex items-center gap-2.5 mb-8">
                  <div className="relative flex h-3 w-3">
                    <span className={`animate-ping absolute inline-flex h-full w-full rounded-full ${outlet.color} opacity-20`}></span>
                    <span className={`relative inline-flex rounded-full h-3 w-3 ${outlet.color}`}></span>
                  </div>
                ...
                <div className="grid gap-6 mb-12">
                  <div className="flex items-center gap-5 group/item">
                    ...
                    <div className="flex flex-col">
                      <span className="text-[10px] uppercase font-black tracking-widest text-slate-300">Hubungi Kami</span>
                      <span className="text-lg font-bold text-slate-700">{outlet.phone}</span>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-5 group/item">
                    ...
                    <div className="flex flex-col gap-1.5 pt-0.5">
                      <span className="text-[10px] uppercase font-black tracking-widest text-slate-300">Jam Operasional</span>
                      <div className="text-sm font-bold text-slate-700 space-y-1">
                        <p className="flex items-center gap-2">
                          <span className="text-slate-400 font-medium w-16">Sen–Jum</span>
                          <span className="bg-slate-100 px-2 py-0.5 rounded text-xs">{outlet.hours.weekday}</span>
                        </p>
                        <p className="flex items-center gap-2">
                          <span className="text-slate-400 font-medium w-16">Sab–Min</span>
                          <span className="bg-brand-accent/20 text-brand-accent-dark px-2 py-0.5 rounded text-xs">{outlet.hours.weekend}</span>
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                >
                  <span className="pl-6 font-bold text-white text-sm">Petunjuk Arah</span>
