...
import { uploadOutletImage, upsertOutlet } from "@/lib/actions/outlets";
								...
								<div className="relative flex items-center justify-between">
									<div>
										<h2 className="text-2xl font-black text-slate-900 tracking-tight font-[family-name:var(--font-heading)]">
											{outlet ? "Edit" : "Registrasi"}{" "}
											<span className="text-brand-primary">Outlet</span>
										</h2>
										...
										<div className="relative group/outlet-img w-full h-40 rounded-[2rem] bg-slate-50 border-2 border-dashed border-slate-200 overflow-hidden flex items-center justify-center transition-all hover:border-brand-primary/30">
											{imageUrl ? (
												<img
													src={imageUrl}
													alt="Preview"
													className="w-full h-full object-cover transition-transform group-hover/outlet-img:scale-110 duration-700"
												/>
											) : (
										...
										<label className="flex items-center gap-3 cursor-pointer group/check">
											<div className="relative flex items-center justify-center">
												<input
													...
													className="peer h-6 w-6 cursor-pointer appearance-none rounded-lg border-2 border-slate-200 bg-white checked:border-emerald-500 checked:bg-emerald-500 transition-all"
												/>
												<span className="absolute text-white opacity-0 peer-checked:opacity-100 transition-opacity pointer-events-none text-xs">
													✓
												</span>
											</div>
											<span className="text-sm font-black text-slate-600 group-hover/check:text-slate-900 transition-colors">
												Aktif
											</span>
										</label>
										<label className="flex items-center gap-3 cursor-pointer group/check">
											<div className="relative flex items-center justify-center">
												<input
													...
													className="peer h-6 w-6 cursor-pointer appearance-none rounded-lg border-2 border-slate-200 bg-white checked:border-brand-primary checked:bg-brand-primary transition-all"
												/>
												<span className="absolute text-white opacity-0 peer-checked:opacity-100 transition-opacity pointer-events-none text-xs">
													✓
												</span>
