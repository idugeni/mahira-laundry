...
export function HomeClient({
  ...
  return (
    <div className="overflow-hidden">
      ...
      {/* Stats Section */}
      <section className="py-24 relative bg-[#0a1a14] overflow-hidden">
        {/* Decorative elements for elite look */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 sm:gap-12 lg:gap-24 text-center">
            {stats.map((stat, i) => (
              <motion.div
                key={stat.label}
              ...
              >
                <div className="text-4xl lg:text-5xl font-black text-amber-400 font-[family-name:var(--font-heading)] mb-3 tracking-tight">
                  {stat.value}
                </div>
                <div className="text-[10px] lg:text-xs font-black text-white/40 uppercase tracking-[0.3em] leading-relaxed">
                  {stat.label}
                </div>
                {/* Subtle glow on hover */}
                <div className="absolute inset-0 bg-amber-400/5 blur-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-700" />
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <section className="py-32 relative overflow-hidden bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <motion.div
            ...
            viewport={{ once: true }}
            className="p-8 sm:p-16 rounded-[2rem] sm:rounded-[3rem] bg-gradient-to-br from-slate-900 to-slate-800 text-white shadow-2xl relative overflow-hidden"
          >
            ...
            <p className="mt-6 text-xl text-white/70 relative z-10 max-w-xl mx-auto">
              Daftar sekarang dan klaim{" "}
              <span className="text-brand-accent font-bold">Diskon 10%</span>{" "}
              untuk order pertama. Masukkan kode{" "}
              <span className="px-2 py-0.5 bg-brand-accent/20 text-brand-accent rounded font-mono">
                MAHIRA10
              </span>
              .
            </p>
            ...
            <div className="mt-12 flex flex-wrap justify-center gap-4 relative z-10">
              {!loading ? (
                ...
                <div className="w-56 h-16 bg-white/10 animate-pulse rounded-full" />
              )}
              <a
              ...
              >
                <span className="w-6 h-6 flex items-center justify-center text-emerald-400 group-hover:text-slate-900 transition-colors">
                  <FaWhatsapp />
                </span>
                Hubungi Kami
              </a>
