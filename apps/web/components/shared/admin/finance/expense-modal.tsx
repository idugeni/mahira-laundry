						...
						<div className="relative bg-white rounded-[2rem] shadow-2xl w-full max-w-lg overflow-hidden animate-fade-in border border-white/20 text-left">
							...
							<div className="px-8 pt-8 pb-6 bg-slate-50 relative overflow-hidden shrink-0 border-b border-slate-100">
								...
								<div className="relative flex items-center justify-between">
									<div className="flex items-center gap-3">
										<div className="w-12 h-12 rounded-2xl bg-white shadow-xs border border-slate-100 flex items-center justify-center text-rose-500">
							...
							<form onSubmit={handleSubmit} className="p-8 space-y-6">
									...
									<div className="space-y-2">
										...
										<div className="relative group/input">
											...
											<input
												...
												name="amount"
												placeholder="0"
												className="w-full pl-12 pr-6 py-4 bg-slate-50 border border-slate-100 rounded-2xl text-xl font-black outline-hidden ring-0 focus:border-rose-500 focus:bg-white transition-all"
											/>
										</div>
									</div>
									...
									<div className="space-y-2">
										...
										<div className="relative group/input">
											...
											<textarea
												...
												className="w-full pl-12 pr-6 py-4 bg-slate-50 border border-slate-100 rounded-2xl text-sm font-bold outline-hidden min-h-[100px] ring-0 focus:border-rose-500 focus:bg-white transition-all resize-none"
											/>
										</div>
									</div>
								</div>
								...
								<button
									type="submit"
									disabled={isLoading}
									className="flex h-11 w-full items-center justify-center gap-3 rounded-xl bg-rose-600 text-sm font-black text-white shadow-lg shadow-rose-100 transition-colors hover:bg-rose-700 disabled:opacity-50"
								>
									{isLoading ? (
