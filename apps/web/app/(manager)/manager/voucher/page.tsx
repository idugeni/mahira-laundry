              ...
              >
                  ...
                  <div className="mt-auto pt-4 flex flex-col gap-2">
                    <div className="w-full bg-slate-100 rounded-full h-1.5 mb-1 overflow-hidden">
                      <div
                        ...
                        style={{
                          width: limit !== "∞" ? `${Math.min((used / Number(limit)) * 100, 100)}%` : "0%",
                        }}
                      />
                    </div>
                    <div className="flex items-center justify-between text-xs font-medium">
                      <span className="text-slate-500">
                        Digunakan: <strong className={isActive ? "text-slate-900" : "text-slate-700"}>{used}</strong> / {limit}
                      </span>
                ...
                <div className="px-5 py-3 border-t border-slate-100 bg-slate-50 flex items-center justify-between">
                  <span className="text-[10px] text-slate-400 font-medium">
                    S.d. {new Date(v.valid_until).toLocaleDateString("id-ID", { day: "numeric", month: "short", year: "numeric" })}
                  </span>
