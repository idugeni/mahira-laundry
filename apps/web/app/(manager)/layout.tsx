...
const managerNav = [
  ...
  { href: "/kelola-layanan", label: "Kelola Layanan", icon: "🧺" },
  { href: "/voucher", label: "Voucher", icon: "🎫" },
  { href: "/inventori", label: "Inventori", icon: "📦" },
  { href: "/tim", label: "Tim", icon: "👥" },
];
    ...
    <div className="min-h-screen flex bg-muted/30">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        <header className="h-16 border-b border-border bg-white flex items-center justify-between px-6">
          ...
          <span className="text-sm text-muted-foreground">Salemba</span>
        </header>
