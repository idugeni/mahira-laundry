...
export default async function OrderDetailPage({
  ...
  const getTimeline = () => {
    const steps = [
      ...
      { status: "ironing", label: "Proses Penyetrikaan", time: order.ironing_at },
      { status: "qc_passed", label: "Quality Control", time: order.qc_passed_at },
      { status: "ready", label: "Siap Diambil/Dikirim", time: order.ready_at },
      { status: "completed", label: "Pesanan Selesai", time: order.completed_at },
    ];
