...
export const metadata: Metadata = {
	...
	description: "Ringkasan keuangan dan finansial seluruh cabang Mahira Laundry.",
};

export const dynamic = "force-dynamic";

export default async function KeuanganPage() {
	const [stats, revenueData, paymentStats, recentPaidOrders, expenses, outletsWithStats] =
		await Promise.all([
			getSuperadminDashboardStats(),
	...
	const margin = stats.totalRevenue > 0 ? ((netProfit / stats.totalRevenue) * 100).toFixed(1) : "0";
