		...
		<div className="space-y-8 animate-fade-in-up">
			...
			<div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
				<div>
					...
					<p className="text-slate-500 mt-1 text-sm">
						{staff.length} staf terdaftar di seluruh cabang Mahira Laundry
						Group.
					</p>
				</div>

				{/* Integrating the Modal Component */}
				<RegisterStaffModal outlets={outlets} />
			</div>
			...
			<div className="bg-slate-100/50 rounded-2xl p-4 border border-slate-200/60 flex items-start gap-3">
				...
				<div className="text-xs text-slate-500 leading-relaxed">
					...
					Akun staf yang didaftarkan akan langsung dapat digunakan untuk masuk
					ke *Panel Kasir* atau *Panel Kurir*. Pastikan email yang digunakan
					valid untuk pemulihan akun di masa mendatang.
				</div>
			</div>
		</div>
	);
